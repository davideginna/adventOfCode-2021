...
public class Day04 {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(is)) {
            pallottoliere = Arrays.stream(scanner.nextLine().split(",")).map(Integer::valueOf).toArray(Integer[]::new);
            scanner.nextLine();//salta riga vuota dopo numeri
        ...
        partOne(pallottoliere, bingoBoards);
        partTwo(pallottoliere, bingoBoards);
    }
