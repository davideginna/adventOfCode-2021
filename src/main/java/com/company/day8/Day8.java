...
public class Day8 {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(Day8.class.getClassLoader().getResourceAsStream("inputs/d8input.txt"))) {
            ...
            while (scanner.hasNextLine()) {
                ...
                List<String> uniqueSignalsFiltered = uniqueSignals.stream().filter(s -> lengthValue.contains(s.length())).collect(Collectors.toList());
